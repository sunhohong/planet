...
describe ItemsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "render edit with next step" do
        post :create, {:item => valid_attributes}, valid_session
        response.should redirect_to(edit_item_path(Item.last))
      end
      
      it "item should have valid step" do
        post :create, {:item => valid_attributes}, valid_session
        Item.last.step.should eq(Item.last.steps[1])
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "re-render edit page when step is not last one" do
        item = Item.create! valid_attributes
        put :update, {:id => item.to_param, :item => valid_attributes.merge({:step => item.steps[-2]})}, valid_session
        response.should render_template("edit")
      end
      
      it "redirect to the item when step is last one" do
        item = Item.create! valid_attributes
        put :update, {:id => item.to_param, :item => valid_attributes.merge({:step => item.steps[-1]})}, valid_session
